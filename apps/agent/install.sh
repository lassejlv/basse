...
PROXY_HTTP_PORT="${BASSE_PROXY_HTTP_PORT:-80}"
PROXY_HTTPS_PORT="${BASSE_PROXY_HTTPS_PORT:-443}"
...
start_agent() {
  ...
  docker_cmd run -d \
    ...
    -e BASSE_PROXY_HTTP_PORT="$PROXY_HTTP_PORT" \
    -e BASSE_PROXY_HTTPS_PORT="$PROXY_HTTPS_PORT" \
